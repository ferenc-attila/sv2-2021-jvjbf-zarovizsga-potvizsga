...
class NewsPaperTest {
    ...
    void testNewsPaperArticlesOrder() {
        assertEquals(List.of("Very Very Important Article!","Very Important Article!","Important Article!","Yellow press"),
                newsPaper.getArticles().stream().map(a->a.getHeader().getContent()).toList());
